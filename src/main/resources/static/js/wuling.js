function findInArr(arr,value,key){
	var rValue = "";
	$.each(arr,function(index,item){
		if(key && item[key.key] == value){
			return rValue = item[key.key]
		}else if(item['itemValue'] == value){
			return rValue = item['itemName']
		}
	});
	return rValue;
}
	...
	$("#topnav").load('/topnav',function(response,status,xhr){
	    if(status=='success'){
	        ...
	        $('.navbar-minimalize').click(function () {
	            ...
	            SmoothlyMenu();
	            if(typeof resizeChart != "undefined"){
...
//    $("#settings-top,#settings-left").bind('click',function(e){
//    	alert('设置密码');
//    });
//    $("#profile-top,#profile-left").bind('click',function(e){
//    	alert('介绍');
//    });
