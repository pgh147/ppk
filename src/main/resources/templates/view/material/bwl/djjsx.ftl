                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="productStatus" id="isOk" class="form-control input-s-sm inline">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                       ...
                       <form name="entity" id="input_form" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-sm-12 col-md-4 col-lg-3 control-label" for="name"><span class="text-danger">* </span>待解决事项： </label>
								<div class="col-sm-12 col-md-7 col-lg-9">
									<textarea   cols="2" name="issues"  rows="6"   style="OVERFLOW:   hidden" class="form-control"></textarea>
								</div>
							</div>		
							<div class="form-group">
								<label class="col-sm-12 col-md-4 col-lg-3 control-label" for="name"><span class="text-danger">* </span>是否解决： </label>
								<div class="col-sm-12 col-md-7 col-lg-9">
								  <label for="huey">未解决</label>
									<input type="radio"  name="isOk" value="1" checked>
									&nbsp;&nbsp;
  <label for="huey">已解决</label>
  <input type="radio"  name="isOk" value="2">
								</div>
							</div>
	...
	<script src="${ctx}/static/page/djjsx.js?v=20220801"></script>
