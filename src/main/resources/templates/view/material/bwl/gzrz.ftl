...
<body class="fixed-sidebar">
                                ...
                                <div class="tablesearch pull-right m-t-xs">
                                   <div class="table-td">
                                        <div class="input-group" >
                                                <input type="text" class="input-sm form-control" name="userNo" id="userNoCode" value="" placeholder="员工编号">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="userNo" name="userNo" value="" placeholder="员工编号" class="form-control">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="isRead" id="isRead" class="form-control input-s-sm inline">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                       ...
                       <form name="entity" id="input_form" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-sm-12 col-md-4 col-lg-3 control-label" for="name"><span class="text-danger">* </span>总结： </label>
								<div class="col-sm-12 col-md-7 col-lg-9">
									<textarea   cols="2" name="workLog"  rows="6"   style="OVERFLOW:   hidden" class="form-control"></textarea>
								</div>
							</div>		
	...
	<script src="${ctx}/static/page/gzrz.js?v=20220801"></script>
